<?php /* Smarty version 2.6.19, created on 2016-05-21 07:55:40
         compiled from todo.html */ ?>
<!-- BEGIN PAGE HEADER-->
<div class="page-bar">
                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption" data-toggle="collapse" data-target=".todo-project-list-content">
                            <span class="caption-subject font-green bold uppercase">PROJECTS </span>
                            <span class="caption-helper visible-sm-inline-block visible-xs-inline-block">click to view project list</span>
                        </div>
                        <div class="actions">
                            <div class="btn-group">
                                <a class="btn green btn-circle btn-sm todo-projects-config" href="#" data-toggle="dropdown" dropdown-menu-hover data-close-others="true">
                ...
                <div class="portlet light">
                    ...
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green bold uppercase">Tune Website</span>
                        </div>
                        <div class="actions">
                            <div class="btn-group">
                                <a class="btn green btn-circle btn-sm" href="#" data-toggle="dropdown" dropdown-menu-hover data-close-others="true"> MANAGE
                                    <i class="fa fa-angle-down"></i>
                                </a>
                                <ul class="dropdown-menu pull-right">
                                    <li>
                                ...
                                <div style="min-height: 600px;">
                                    <div class="todo-tasklist">
                                        <div class="todo-tasklist-item todo-tasklist-item-border-green">
                                            <img class="todo-userpic pull-left" src="{{settings.assetsPath}}/pages/media/users/avatar4.jpg" width="27px" height="27px">
                                        ...
                                        <div class="todo-tasklist-item todo-tasklist-item-border-red">
                                            <img class="todo-userpic pull-left" src="{{settings.assetsPath}}/pages/media/users/avatar5.jpg" width="27px" height="27px">
                                        ...
                                        <div class="todo-tasklist-item todo-tasklist-item-border-green">
                                            <img class="todo-userpic pull-left" src="{{settings.assetsPath}}/pages/media/users/avatar9.jpg" width="27px" height="27px">
                                            <div class="todo-tasklist-item-title"> Slider Redesign </div>
                                            <div class="todo-tasklist-controls pull-left">
                                                <span class="todo-tasklist-date">
                                        ...
                                        <div class="todo-tasklist-item todo-tasklist-item-border-blue">
                                            <img class="todo-userpic pull-left" src="{{settings.assetsPath}}/pages/media/users/avatar6.jpg" width="27px" height="27px">
                                        ...
                                        <div class="todo-tasklist-item todo-tasklist-item-border-purple">
                                            <img class="todo-userpic pull-left" src="{{settings.assetsPath}}/pages/media/users/avatar7.jpg" width="27px" height="27px">
                                        ...
                                        <div class="todo-tasklist-item todo-tasklist-item-border-yellow">
                                            <img class="todo-userpic pull-left" src="{{settings.assetsPath}}/pages/media/users/avatar8.jpg" width="27px" height="27px">
                                ...
                                <div style="min-height: 600px;">
                                    <form action="#" class="form-horizontal">
                                        ...
                                        <div class="form">
                                            <div class="form-group">
                                                <div class="col-md-8 col-sm-8">
                                                    <div class="todo-taskbody-user">
                                                        <img class="todo-userpic pull-left" src="{{settings.assetsPath}}/pages/media/users/avatar6.jpg" width="50px" height="50px">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <input type="text" class="form-control todo-taskbody-tags" placeholder="Tags..." value="Pending, Requested"> </div>
                                            </div>
                                            <!-- TASK TAGS -->
                                        ...
                                        <div class="tabbable-line">
                                            <ul class="nav nav-tabs ">
                                                <li class="active">
                                                    <a href="#" data-target="#tab_1" data-toggle="tab"> Comments </a>
                                                </li>
                                                <li>
                                                    <a href="#" data-target="#tab_2" data-toggle="tab"> History </a>
                                                </li>
                                            </ul>
                                                            ...
                                                            <ul class="media-list">
                                                                <li class="media">
                                                                    <a class="pull-left" href="#">
                                                                        <img class="todo-userpic" src="{{settings.assetsPath}}/pages/media/users/avatar8.jpg" width="27px" height="27px"> </a>
                                                                    <div class="media-body todo-comment">
                                                                        ...
                                                                        <p class="todo-text-color"> Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. </p>
                                                                        <!-- Nested media object -->
                                                                        <div class="media">
                                                                            <a class="pull-left" href="#">
                                                                                <img class="todo-userpic" src="{{settings.assetsPath}}/pages/media/users/avatar4.jpg" width="27px" height="27px"> </a>
                                                                ...
                                                                <li class="media">
                                                                    <a class="pull-left" href="#">
                                                                        <img class="todo-userpic" src="{{settings.assetsPath}}/pages/media/users/avatar5.jpg" width="27px" height="27px"> </a>
                                                                    <div class="media-body todo-comment">
                                                                        <button type="button" class="todo-comment-btn btn btn-circle btn-default btn-xs">&nbsp; Reply &nbsp;</button>
                                                                        <p class="todo-comment-head">
                                                                        ...
                                                                        <p class="todo-text-color"> Cras sit amet nibh libero, in gravida nulla. Scelerisque ante sollicitudin commodo Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate
                                                                ...
                                                                <li class="media">
                                                                    <a class="pull-left" href="#">
                                                                        <img class="todo-userpic" src="{{settings.assetsPath}}/pages/media/users/avatar6.jpg" width="27px" height="27px"> </a>
                                                                    <div class="media-body todo-comment">
                                                                        <button type="button" class="todo-comment-btn btn btn-circle btn-default btn-xs">&nbsp; Reply &nbsp;</button>
                                                                        <p class="todo-comment-head">
